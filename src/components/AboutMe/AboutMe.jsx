...
function AboutMe () {
    return(
            <div className='resume__aboutme'>
                <div className='resume__aboutme-img'>
                    <img src={Syaam} />
                </div>
                <div className='resume__aboutme-text' href>
                    <p>
                        ...
                        <p className='resume__aboutme-text-tag'>
                           ...
                           front end tools such as React and Bootstrap through projects such as this one.
                        </p>
                        <p className='resume__aboutme-text-linebreak'>
                            <br></br>
                            <br></br>
                            <br></br>
                            <br></br>
                        ...
                        <div className='resume__aboutme-text-button'>
